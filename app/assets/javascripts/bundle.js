...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserApiUtil = __webpack_require__(170);
	...
	var UserActions = {
		...
		guestLogin: function guestLogin() {
			UserActions.login({ email: "cass.baltz@gmail.com", password: "password" });
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserApiUtil = {
		...
		fetchCurrentUser: function fetchCurrentUser(success, error) {
			$.ajax({
				url: '/api/session',
				method: 'get',
				success: success,
